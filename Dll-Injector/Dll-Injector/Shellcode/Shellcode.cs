...
namespace Dll_Injector.Shellcode
{
    class Shellcode
    {
        ...
        public static byte[] threadhijacking_shellcode_x86 = new byte[]  {
        ...
        public static byte[] threadhijacking_shellcode_x64 = new byte[]
        {
            // save return insturction pointer
		    0x48, 0x83, 0xec, 0x08,	// sub rsp,0x8
		    0xC7, 0x04, 0x24, 0xCC, 0xCC, 0xCC, 0xCC,		//  mov DWORD PTR[rsp],0xcccccccc
		    0xC7, 0x44, 0x24, 0x04, 0xCC, 0xCC, 0xCC, 0xCC, //  mov DWORD PTR[rsp + 0x4],0xcccccccc
		    ...
		    0x48, 0xBB, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rbx, funcAddress	offset 42
		    0x48, 0xB9, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rcx, parameter	offset 52
																																																					   																											   
		    // align to 16 bytes
		    0x48, 0x89, 0xe0,		//	mov    rax,rsp 
            0x48, 0x83, 0xec, 0x10,	//	sub rsp,0x10
		    0x48, 0x83, 0xe4, 0xf0, //	and rsp, 0xfffffffffffffff0 (force alignment to 16 bytes)
		    0x48, 0x83, 0xec, 0x08,	//	sub rsp,0x8
		    0x50,					//	push rax
		    ...
		    // call own function
		    0xFF, 0xD3,				//	call rbx														   
		    0x48, 0xa3, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, //	movabs ds:0xcccccccccccccccc,rax	(move returnvalue to address)		Offset 84
	   		  
		    // SUSPEND THREAD
		    0x48, 0xBB, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rbx, address of GetCurrentThread()	offset 94
		    0xFF, 0xD3,				//	call rbx
		    0x48, 0x8B, 0xC8,       //	mov rax, rcx

		    0x48, 0xBB, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rbx, address of Suspendthread()	offset 109
		    0xFF, 0xD3,				//	call rbx
		    0x48, 0xa3, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, //	movabs ds:0xcccccccccccccccc,rax	(move returnvalue of Suspendthread() to address)		Offset 121

		    // remove shadow space
		    0x48, 0x83, 0xC4, 0x20, //  add rsp,0x20

		    // restore to pre alignment state
		    0x58,					//	pop rax
        ...
        public static byte[] GetThreadHijackShellcodeX86_64(UInt64 funcaddress, UInt64 param, UInt64 returnaddress, UInt64 returninstruction, UInt64 getcurrentthreadaddress, UInt64 suspendthreadaddress, UInt64 suspendthreadreturnaddress)
        {
            byte[] shellcode = new byte[]  {
		        ...
		        0x48, 0xBB, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rbx, funcAddress	offset 34
		        0x48, 0xB9, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rcx, parameter	offset 44
		        ...
		        // call own function
		        0xFF, 0xD3,				//	call rbx														   
		        0x48, 0xa3, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, //	movabs ds:0xcccccccccccccccc,rax	(move returnvalue to address)		Offset 72
	   		  
		        // SUSPEND THREAD
		        0x48, 0xBB, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rbx, address of GetCurrentThread()	offset 82
		        0xFF, 0xD3,				//	call rbx
		        0x48, 0x8B, 0xC8,       //	mov rax, rcx

		        0x48, 0xBB, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC,	//	movabs rbx, address of Suspendthread()	offset 97
		        0xFF, 0xD3,				//	call rbx
		        0x48, 0xa3, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xcc, //	movabs ds:0xcccccccccccccccc,rax	(move returnvalue of Suspendthread() to address)		Offset 109
            ...
            BinaryConverter.CopyToByteArray((UInt32)(returnaddress), shellcode, 7);
            BinaryConverter.CopyToByteArray((UInt32)(returnaddress >> 32), shellcode, 15);
            BinaryConverter.CopyToByteArray(funcaddress, shellcode, 34);
            BinaryConverter.CopyToByteArray(param, shellcode, 44);            
            BinaryConverter.CopyToByteArray(returnaddress, shellcode, 72);
            BinaryConverter.CopyToByteArray(getcurrentthreadaddress, shellcode, 82);
            BinaryConverter.CopyToByteArray(suspendthreadaddress, shellcode, 97);
            BinaryConverter.CopyToByteArray(suspendthreadreturnaddress, shellcode, 109);
            return shellcode;
        }
    }
}
