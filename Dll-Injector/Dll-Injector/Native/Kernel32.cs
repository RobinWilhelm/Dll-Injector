...
namespace Dll_Injector.Native
{
    ...
    class Kernel32
    {
        ...
        [DllImport("kernel32.dll", SetLastError = true, ExactSpelling = true)]
        public static extern bool VirtualFreeEx(SafeProcessHandle hProcess, IntPtr lpAddress, uint dwSize, AllocationType dwFreeType);
        ...
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern IntPtr OpenThread(UInt32 dwDesiredAccess, [MarshalAs(UnmanagedType.Bool)] bool bInheritHandle, UInt32 dwThreadId);
